                    ...
                    {/* <li className='text-center' >
                        <div className='top-product-image mb-4 position-relative d-center'>
                            <div className="position-absolute w-100 h-100 d-center" >
                                <div className='d-flex justify-content-between w-100 fs-16 violaPurple' style={{backgroundColor:'#FFFFFFCC', padding: '1px 10px'}}>
                                    <div className='d-center'>
                                        <img className='me-1' style={{width:'24px'}} src="/images/icons/delivering@2x.png" alt="" />
                                        <span>18 Transaction</span>
                                    </div>
                                    <div className='d-center'>
                                        <img className='me-1' style={{width:'24px'}} src="/images/icons/kilogram@2x.png" alt="" />
                                        <span>18 Tons</span>
                                    </div>
                                </div>
                            </div>
                            <div className="p-3">
                                <img className='w-100 h-100' src="/images/products/potato.png" alt="" />
                            </div>
                        </div>
                        <span className='smokeyGrey fs-22'> First Grade Apple </span>
                    </li> */}
